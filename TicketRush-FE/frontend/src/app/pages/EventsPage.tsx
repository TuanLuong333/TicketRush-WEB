...
export default function EventsPage() {
  ...
  const eventSearchSuggestions = useMemo(
    () => uniqueAutocompleteSuggestions(events.flatMap(event => [event.title, event.location, getEventCity(event)])),
    [events],
  );
          ...
          <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
            ...
            <div>
              <AutocompleteInput
                ...
                leadingIcon={<Search size={20} style={{ color: '#94A3B8' }} />}
